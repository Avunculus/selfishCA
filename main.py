...
def flip_totalistic(cells:np.ndarray, kernel:np.ndarray, rule:np.ndarray) -> np.ndarray:
...
def show(sfc:pg.Surface, cells:np.ndarray) -> None:
...
if __name__ == '__main__':
    ...
    hood = 'M'
    hood_size = 1
    val_range = 3       # cell values are in range(3)
